...
CREATE TABLE public.photographer_specialties (
    ...
    level TEXT DEFAULT 'Especialista', -- 'Especialista', 'Bronze', 'Prata', 'Ouro', 'Elite'
...
('tenis', 'Tênis', '🎾', 3, 100),
('casamentos', 'Casamentos', '💍', 20, 0), -- Casamento geralmente é pacote, não por foto avulsa
('rodeio', 'Rodeio', '🤠', 5, 150);

-- 4. Criar tabela de Reputação (base para "Minha Reputação")
...
-- 5. Limpar referências a Embaixador nos benefícios de níveis
UPDATE public.level_rules 
SET benefits = array_remove(benefits, 'Comissão de indicação 1%'),
    commission_pct = 0
