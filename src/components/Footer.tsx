  ...
  <footer className="bg-card border-t border-border mt-20">
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
        <div>
          <h4 className="h5 mb-4">Institucional</h4>
          <ul className="space-y-2 body-small text-muted-foreground">
        ...
        <div>
          <h4 className="h5 mb-4">Venda suas fotos</h4>
          <ul className="space-y-2 body-small text-muted-foreground">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-border">
        <div className="flex items-center gap-2 mb-4 md:mb-0">
          ...
          <span className="caption text-muted-foreground">© 2026 Todos os direitos reservados</span>
        </div>
