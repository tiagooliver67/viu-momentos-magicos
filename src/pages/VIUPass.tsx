          ...
          <div className="max-w-lg mx-auto">
            <div className="glass-card p-8 neon-border relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <button className="w-full py-4 rounded-xl bg-primary text-primary-foreground font-black text-lg hover:bg-primary/90 transition-all hover:shadow-[0_0_30px_rgba(255,77,0,0.4)] flex items-center justify-center gap-2">
